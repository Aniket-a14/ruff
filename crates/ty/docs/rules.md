...
- [`truthiness-test-of-callable`](#truthiness-test-of-callable) warns when a `Callable`-typed value is tested without being called.
- [`truthiness-test-of-iterable`](#truthiness-test-of-iterable) warns when an iterable might be truthy even if it is empty.
...
- [`redundant-condition`](#redundant-condition) reports conditions whose inferred types make them always truthy or falsy,
    such as a function that was not called.
- [`redundant-condition-strict`](#redundant-condition-strict) reports additional always-truthy or always-falsy conditions when
    enabled.
